...
<body>
   ...
   <div class="container-fluid bg-primary p-3 d-flex justify-content-between">
      <h3 class="text-white">Welcome to E-Learning</h3>
   ...
   <div class="container-fluid">
      <div class="row">
         ...
         <div class="col-sm-9">
            <video id="videoarea" src="" class="mt-5 w-100 h-auto mx-2" controls>
            </video>
         </div>
      </div>
   </div>
