...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 14, 2023 at 01:16 PM
...
INSERT INTO `bank_tb` (`id`, `uname`, `acctnum`, `bank`) VALUES
(1, '  Victor Ikechukwu', '0638083034', 'GTBank');
...
(10, 'Learn Python A-Z', 'This is the most comprehensive, yet straight-forward, course for the Python programming language.', 'Rahul Kumar', '../image/courseimg/3d77c718789f55f2d7425a80886372af.jpg', '4 Months', 0, 0),
...
(18, 'Mathematics', 'Basic mathematics tutorial for kids', 'V-pro services', '../image/courseimg/f68f5496258eb54eefd23f3464f6b37d.jpg', '2hrs 45mins', 4700, 5000);
...
CREATE TABLE `courseorder` (
  ...
  `paid` varchar(10) COLLATE utf8_bin NOT NULL,
  `proof` varchar(255) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `courseorder` (`co_id`, `order_id`, `stu_email`, `course_id`, `status`, `respmsg`, `amount`, `paid`, `proof`, `order_date`) VALUES
(3, 'ORDS98956453', 'ant@example.com', 10, 'TXN_SUCCESS', 'Txn Success', 800, 'no', '', '2019-09-12'),
(7, 'ORDS57717951', 'jay@ischool.com', 14, 'TXN_SUCCESS', 'Txn Success', 400, 'no', '', '2019-09-13'),
(8, 'ORDS22968322', 'mario@ischool.com', 10, 'TXN_SUCCESS', 'Txn Success', 800, 'no', '', '2019-09-13'),
(9, 'ORDS78666589', 'ignou@ischool.com', 10, 'TXN_SUCCESS', 'Txn Success', 800, 'no', '', '2019-09-19'),
(10, 'ORDS59885531', 'sonam@gmail.com', 10, 'TXN_SUCCESS', 'Txn Success', 800, 'no', '', '2020-07-04'),
(11, 'ORDS25838315', 'cap@example.com', 8, 'Success', 'Done', 1655, 'no', '', '2008-03-23'),
(12, 'ORDS65764801', 'sonam@gmail.com', 16, 'Success', 'Done', 500, 'yes', 'brk3.jpg', '2008-03-23'),
(13, 'ORDS34549979', 'sonam@gmail.com', 8, 'Success', 'Done', 1655, 'no', '', '2011-03-23'),
(14, 'ORDS58429979', 'sonam@gmail.com', 9, 'Success', 'Done', 700, 'no', '', '2011-03-23');
...
(182, '  sonam', 'sonam@gmail.com', '123456', '  Web Dev', '../image/stu/WhatsApp Image 2023-03-10 at 10.23.17.jpeg');
